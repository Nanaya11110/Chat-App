<div class="py-4 flex-2 flex flex-row ">
    <div class="flex-1">
        <span class="MainMenu xl:hidden inline-block text-gray-700 hover:text-gray-900 align-bottom ">
        ...
        <span class="list lg:hidden inline-block ml-8 text-gray-700 hover:text-gray-900 align-bottom">
            <span class="block h-6 w-6 p-1 rounded-full hover:bg-gray-400">
